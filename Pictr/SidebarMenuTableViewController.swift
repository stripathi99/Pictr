...
//  Pictr
//
//  Created by Shubham Tripathi on 05/12/15.
...
//    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let controller = navController.topViewController as! MovieCollectionViewController
        
        switch(segue.identifier!) {
            case "nowPlaying":
                controller.moviesToDisplay = "Now Playing"
            case "topRated":
                controller.moviesToDisplay = "Top Rated"
            case "popular":
                controller.moviesToDisplay = "Popular"
            case "upcoming":
                controller.moviesToDisplay = "Upcoming"
            default: break
        }
    }
